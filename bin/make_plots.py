...
plt.close(fig)
fig = plotter.width_bin()
fig.savefig(f'{stagedir}/{uargs.tracer}_{uargs.survey}_{uargs.version}_N_width.pdf')
plt.close(fig)
fig = plotter.slope_bin()
fig.savefig(f'{stagedir}/{uargs.tracer}_{uargs.survey}_{uargs.version}_N_slope.pdf')
plt.close(fig)
fig = plotter.intercept_bin()
fig.savefig(f'{stagedir}/{uargs.tracer}_{uargs.survey}_{uargs.version}_N_intercept.pdf')
plt.close(fig)
...
plt.close(fig)
fig = plotter.width_bin()
fig.savefig(f'{stagedir}/{uargs.tracer}_{uargs.survey}_{uargs.version}_S_width.pdf')
plt.close(fig)
fig = plotter.slope_bin()
fig.savefig(f'{stagedir}/{uargs.tracer}_{uargs.survey}_{uargs.version}_S_slope.pdf')
plt.close(fig)
fig = plotter.intercept_bin()
fig.savefig(f'{stagedir}/{uargs.tracer}_{uargs.survey}_{uargs.version}_S_intercept.pdf')
plt.close(fig)
mode = 'physical' if uargs.physical else None
figs = plotter.imputation_fits(mode=mode, extended=uargs.extend)
